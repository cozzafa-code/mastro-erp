...
export default function Home() {
    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 13, color: '#86868b' }}>Caricamento...</div>
        </div>
      </div>
    )
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F2F1EC', fontFamily: "'Plus Jakarta Sans', -apple-system, sans-serif" }}>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '100px 32px 80px', textAlign: 'center' }}>
        <div style={{
          display: 'inline-block', padding: '6px 16px', borderRadius: 100,
          background: 'rgba(208,128,8,0.1)', border: '1px solid rgba(208,128,8,0.2)',
          fontSize: 13, fontWeight: 600, color: '#D08008', marginBottom: 24,
        }}>
          L&apos;ERP pensato per i serramentisti
        </div>
        <h1 style={{
          fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 800, color: '#1A1A1C',
          lineHeight: 1.05, letterSpacing: -2, marginBottom: 20,
        }}>
          Gestisci le tue<br /><span style={{ color: '#D08008' }}>commesse</span> senza pensieri
        </h1>
        <p style={{
          fontSize: 'clamp(16px, 2vw, 20px)', color: '#6B6B6F', lineHeight: 1.6,
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/login" style={{
            padding: '14px 32px', borderRadius: 12, background: '#D08008', color: '#fff',
          ...
          <a href="#funzioni" style={{
            padding: '14px 32px', borderRadius: 12, background: '#fff', color: '#1A1A1C',
            fontSize: 16, fontWeight: 600, textDecoration: 'none', border: '1px solid rgba(26,26,28,0.1)',
          }}>
            Scopri le funzioni ↓
          </a>
        </div>
      ...
      <section id="funzioni" style={{ maxWidth: 1000, margin: '0 auto', padding: '0 32px 80px' }}>
        <h2 style={{ fontSize: 32, fontWeight: 800, color: '#1A1A1C', textAlign: 'center', marginBottom: 48, letterSpacing: -1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
          {[
            ...
            { ico: '📐', title: 'Misure digitali', desc: '6 punti + 2 diagonali per vano. Controllo fuori squadra automatico.' },
            ...
            { ico: '⚙️', title: 'Configuratore', desc: 'Sistemi, colori, vetri, coprifili, lamiere. Tutto personalizzabile.' },
          ].map((f, i) => (
            <div key={i} style={{ padding: 28, borderRadius: 16, background: '#fff', border: '1px solid rgba(26,26,28,0.06)' }}>
      ...
      <section style={{ maxWidth: 700, margin: '0 auto', padding: '60px 32px' }}>
        <div style={{ padding: 40, borderRadius: 20, background: '#1A1A1C', color: '#F2F1EC', textAlign: 'center' }}>
          <h2 style={{ fontSize: 28, fontWeight: 800, marginBottom: 16 }}>
            Costruito da chi fa serramenti,<br />per chi fa serramenti.
          </h2>
          <p style={{ fontSize: 15, color: '#9B9B9F', lineHeight: 1.7, maxWidth: 480, margin: '0 auto 28px' }}>
            MASTRO nasce in cantiere, non in Silicon Valley. Sappiamo cosa serve perché lo usiamo ogni giorno.
          </p>
          <Link href="/login" style={{
            display: 'inline-block', padding: '14px 32px', borderRadius: 12,
            background: '#D08008', color: '#fff', fontSize: 15, fontWeight: 700, textDecoration: 'none',
          }}>
      ...
      <footer style={{
        ...
        flexWrap: 'wrap', gap: 16, borderTop: '1px solid rgba(26,26,28,0.06)',
        fontSize: 13, color: '#9B9B9F',
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{
            width: 24, height: 24, borderRadius: 6, background: '#1A1A1C', color: '#D08008',
            display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 800,
          }}>M</div>
          <span>MASTRO ERP</span>
        </div>
        <div>© 2026 MASTRO · ERP per serramentisti</div>
      </footer>
    </div>
  )
}
