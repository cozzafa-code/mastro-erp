...
export default function MastroMisure() {
          ...
          {showModal === "commessa" && (
            <>
              ...
              {newCM.tipo === "riparazione" && (() => {
                ...
                return (
                  <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
                    ...
                    {/* 2 — Se cliente nuovo: nome + indirizzo + telefono */}
                    {!ripCMSel && (
                    ...
                    {/* 4 — Tipo problema (selezione rapida) */}
                    <div>
                    ...
                    {/* 6 — Vano specifico (solo se commessa collegata con vani) */}
                    ...
                    <div>
                      ...
                      {ripFotos.length === 0
                        ? <div onClick={() => document.getElementById("ripFotoInput").click()}
              ...
              {newCM.tipo === "nuova" && (() => {
                ...
                const sNuovo = cantieri.filter(c=>c.code&&c.code.startsWith("S-")).length;
  ...
  const renderPreventivoModal = () => {
    ...
    const vaniPrezzo0 = vaniCalc.filter(v=>v.calc.tot===0);
          ...
          <div style={{padding:"0 16px"}}>
            ...
            <div style={{background:"#fff",borderRadius:12,padding:"14px",marginBottom:10}}>
              ...
              {vaniCalc.length===0?<div style={{fontSize:12,color:"#999",textAlign:"center",padding:12}}>Nessun vano</div>:vaniCalc.map((v,i)=>(
                <div key={v.id} style={{padding:"8px 0",borderBottom:"1px solid #f5f5f7",background:v.calc.tot===0?"#fff5f5":"transparent",borderRadius:v.calc.tot===0?8:0,padding:v.calc.tot===0?"8px":undefined}}>
